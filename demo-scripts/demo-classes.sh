...
CLASSES_DATA=$DATA_DIR/classes/classes.txt
...
sort $CLASSES_DATA -k 2 -n > $DATA_DIR/classes/classes.sorted.txt
echo The word classes were saved to file $DATA_DIR/classes/classes.sorted.txt
